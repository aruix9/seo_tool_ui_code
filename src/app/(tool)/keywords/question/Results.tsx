            ...
            {data.keywords &&
              data.keywords.map((keyword, i) => (
                ...
                >
                  ...
                  <td className="p-4">
                    <span
                      className={`bg-${getDifficulty(keyword.difficulty)[1]}-100 text-${getDifficulty(keyword.difficulty)[1]}-700 dark:bg-${getDifficulty(keyword.difficulty)[1]}-900/30 dark:text-${getDifficulty(keyword.difficulty)[1]}-400 px-2 py-1 rounded text-[10px] font-bold uppercase tracking-tight`}
                    >
                      {getDifficulty(keyword.difficulty)[0]} (
                      {keyword.difficulty})
                    </span>
                  </td>
                  <td className="p-4 text-sm text-right text-slate-600 dark:text-slate-300">
