...
export function GapSummary({ noLinksRequired, competitorName, allUrls, showLink = true }: GapSummaryProps) {
  return (
    <div className="bg-primary/5 rounded-xl p-5 border border-primary/10">
      ...
      <div className="space-y-3">
        {showLink && (
          <div>
            <Link href={`/audit/compare/refdomains?targets=${allUrls.join(',')}`} className="inline-flex items-center gap-1 text-[11px] font-bold text-primary hover:underline group">
