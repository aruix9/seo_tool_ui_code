...
const CardAquireLinks = ({noLinksRequired, allUrls}) => {
    return (
        <Link href={`/audit/compare/refdomains?targets=${allUrls.join(",")}`} className="block bg-primary hover:bg-primary/95 transition-all rounded-xl p-8 text-white shadow-xl shadow-primary/20 relative overflow-hidden group">
