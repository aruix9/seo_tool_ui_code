  ...
  return (
    <Suspense fallback={<div className="w-full max-w-[1440px] mx-auto"><LoadingSkeleton /></div>}>
      <Breadcrumb items={[
        { label: "Home", href: "/" },
        { label: "AI", href: "/ai" },
        { label: "Keyword by Brand" },
      ]}
      />
      <main className="max-w-[1440px] mx-auto px-6 pb-8 w-full">
        <HeroTitle />
        <TabNavigations activeTab={3} />
        <Filters currentUrl="/ai/keyword-brand" setKeywordData={setKeywordData} setIsLoading={setIsLoading} getKeywordData={getAiKeywordsByTargetData} />
...
export default AiKeywordByBrandPage;
