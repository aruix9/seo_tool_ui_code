...
const urlLikeSchema = z.string().min(3, "URL is too short").regex(/^(https?:\/\/)?([\w.-]+)\.([a-z]{2,})(\/.*)?$/i,"Please enter a valid URL or domain")
...
const UrlSchema = z.object({
  ...
  backlinkTypes: z.array(z.enum(["dofollow", "nofollow", "sponsored"])).optional(),
...
const AuditPage = () => {
  ...
  const onSubmit = (values: UrlFormValues) => {
    ...
    params.set("includeHistoricalData", values.includeHistoricalData.toString())
