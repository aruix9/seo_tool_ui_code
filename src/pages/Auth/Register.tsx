...
export default function Register() {
  return (
    <section className="max-w-[1440px] px-6 mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-8 order-2 lg:order-1">
          ...
          <div className="flex gap-8 items-center text-slate-500">
            <div className="flex -space-x-3 overflow-hidden">
              <img alt="Avatar of a male user" className="inline-block h-8 w-8 rounded-full ring-2 ring-white object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA2uOl6p4QctgqC9VvjwWFMIdcGdFx1HjIAWa429ZuMT4KmoyHejeKkjXgqXVnosHx1E4L1t2gnllpsUHw1xSP-sf2zCBEK65WTWmAd__ebk-MgHy7Hdx9COyvvIV5H0KGkyEl_Oah_qTWDkBTOWE3Qu14521GPsXlrpZB-LqHMWjfWQAn1FFtOfTSfpm0yrvBcEMri-qqemFykB-bZNRTy2vbvq_yqbbcLucJtOhm_3SyUdQ5UdarxFYQNXMJVC7GnOaahKPkP-iZA" />
              <img alt="Avatar of a female user" className="inline-block h-8 w-8 rounded-full ring-2 ring-white object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAqxCMf2lY3V8M5o7_eiYEJrAt9xoe-OManZQ8Ke6sBMmhGkVewhDgIN_7hkutkNsX5owbDf44laJOSBV1YFrgLn7R-3CbjyneAVi8764cao6lEQ1RW-4W9PktJcjYwrJC8-2-d-9kP-zzuG2MvLqvIMVEQmNVUqrUCZyILlfD-IN-m9edK1mQolGq3T0xRJCUgMGDMVhftIAVTLCuyMziV7VpfWR-4wcZoVQJvXh0aiBL7yPlMBW3Fb7QEB-xd2o2yR_qZbBOsXjIA" />
              <img alt="Avatar of a professional male" className="inline-block h-8 w-8 rounded-full ring-2 ring-white object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBoB8jyo6hlxeVa6CusXWjL0kZthLpWlymVUwv2Oom_8mJFxL-v1gCxoGnnwukQM2uqwPK27HU-9alxoa0R8jeszBfe29wHqwl5hqzMRh9VZphIcjdo-CnLoPDyjYSGkADeBILL5rXnDLTOyiGN0URZt5rd8aFVgbXwhF8u3S6YBH88J1O0iGQbrntjXfgb_c4NUPdbsr65mYY_FoNFJLzVDuGpzUwMXLRPoeaCBqzeITt_84KBGdD-oEP66nh8zvaz9An_mkALoAon" />
            </div>
        ...
        <div className="order-1 lg:order-2">
          <div className="bg-background-light p-8 md:p-12 rounded-xl shadow-xl shadow-primary/5 border border-primary/10">
            <div className="mb-8">
            ...
            <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  className="h-12 px-4 rounded-lg border-slate-200 bg-white focus-visible:ring-primary/50 focus-visible:border-primary" 
                />
              </div>
              ...
              <Button type="submit" className="w-full h-14 bg-primary hover:bg-primary/90 text-white font-bold rounded-xl shadow-lg shadow-primary/30 transition-all flex items-center justify-center gap-2 group text-base">
